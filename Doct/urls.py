...
urlpatterns = patterns('',
		...
		url(r'^doct_view_illness/$', views.doct_view_illness, name='doct_view_illness'),
		...
		url(r'^tellillness/$', views.tellillness, name='tellillness'),
		# url(r'^illnessInput/$', views.illnessInput, name='illnessInput'),
