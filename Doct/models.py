...
class Register(models.Model):
	...
	# user = models.OneToOneField(User)
	fname = models.CharField(blank=False, max_length=20,  default=False)
	sname = models.CharField(blank=False, max_length=30,  default=False)
	page = models.IntegerField(blank=False)
	gender = models.CharField(blank=False, max_length=30,  default=False)
	telno = models.CharField(blank=False, max_length=20,  default=False)
	username = models.CharField(blank=False, max_length=20, unique=True, default=False)
	password= models.CharField(max_length=30)
	email = models.CharField(blank=False,max_length=50,  default=False)
	street = models.CharField(blank=False,max_length=50,  default=False)
	city = models.CharField(blank=False,max_length=20, default=False)
	state = models.CharField(blank=False,max_length=20,  default=False)
	zip_code = models.CharField(blank=False,max_length=5,  default=False)
